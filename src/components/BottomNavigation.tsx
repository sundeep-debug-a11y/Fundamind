...
export function BottomNavigation({ activeTab, onTabChange }: BottomNavigationProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm border-t border-border shadow-lg z-50 max-w-[440px] mx-auto" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
