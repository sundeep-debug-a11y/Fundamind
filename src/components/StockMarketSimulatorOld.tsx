import { ArrowLeft, TrendingUp, TrendingDown, Plus, Minus, Search, RefreshCw } from "lucide-react";
...
import { POPULAR_US_STOCKS, POPULAR_INDIAN_STOCKS } from "../services/stockApi";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function StockMarketSimulator({ onBack }: StockMarketSimulatorProps) {
  ...
  const [watchlist] = useState([...POPULAR_US_STOCKS.slice(0, 6), ...POPULAR_INDIAN_STOCKS.slice(0, 4)]);
  ...
  // Initialize portfolio with some demo holdings
  useEffect(() => {
